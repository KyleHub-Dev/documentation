...
- Zitadel is reachable at `https://zitadel.yourdomain.com` and configured according to the [Network Configuration](08-network-configuration.mdx) guide.
...
## Step 1 – Prepare a project and service account in Zitadel
...
3. Inside the project, add a **Service** → **Application** of type **Web** with the following settings:
