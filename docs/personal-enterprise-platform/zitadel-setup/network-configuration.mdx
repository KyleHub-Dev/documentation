...
**Note**: External domain configuration is covered in the [Post-Installation](../post-installation.mdx#41-set-external-domain) section. Please follow those steps first before proceeding with network configuration.
