...
**Troubleshooting**: If you get "[unknown] Failed to fetch" errors, especially on user profile pages, check the [Network Configuration troubleshooting](04-network-configuration.mdx#212-frontend-api-communication-issues) section.
